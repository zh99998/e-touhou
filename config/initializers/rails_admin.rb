# RailsAdmin config file. Generated on March 14, 2013 10:02
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['e-touhou', '管理面板']
  ...
  # config.excluded_models = ['Bili', 'Category', 'Character', 'Comic', 'Comment', 'Page', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Bili', 'Category', 'Character', 'Comic', 'Comment', 'Page', 'Role', 'User']
  ...
  # config.model 'Bili' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your bili.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your comic.rb model definition
  ...
  #     configure :translator, :string 
  #     configure :publish, :string 
  #     configure :x_rated, :boolean 
  #     configure :under_review, :boolean 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :comic, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :comic_id, :integer         # Hidden 
  ...
  #     configure :comic, :belongs_to_association 
  #     configure :user, :belongs_to_association 
  #     configure :bilis, :has_many_association 
