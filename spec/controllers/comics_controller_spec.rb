  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved comic as @comic" do
        ...
        post :create, {:comic => { "name" => "invalid value" }}, valid_session
        assigns(:comic).should be_a_new(Comic)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested comic" do
        ...
        Comic.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => comic.to_param, :comic => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the comic as @comic" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Comic.any_instance.stub(:save).and_return(false)
        put :update, {:id => comic.to_param, :comic => { "name" => "invalid value" }}, valid_session
        assigns(:comic).should eq(comic)
      end
