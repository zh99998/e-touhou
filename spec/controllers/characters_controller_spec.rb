  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved character as @character" do
        ...
        post :create, {:character => { "name" => "invalid value" }}, valid_session
        assigns(:character).should be_a_new(Character)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested character" do
        ...
        Character.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => character.to_param, :character => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the character as @character" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Character.any_instance.stub(:save).and_return(false)
        put :update, {:id => character.to_param, :character => { "name" => "invalid value" }}, valid_session
        assigns(:character).should eq(character)
      end
