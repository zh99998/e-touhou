  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved comment as @comment" do
        ...
        post :create, {:comment => { "comic" => "invalid value" }}, valid_session
        assigns(:comment).should be_a_new(Comment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested comment" do
        ...
        Comment.any_instance.should_receive(:update_attributes).with({ "comic" => "" })
        put :update, {:id => comment.to_param, :comment => { "comic" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the comment as @comment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Comment.any_instance.stub(:save).and_return(false)
        put :update, {:id => comment.to_param, :comment => { "comic" => "invalid value" }}, valid_session
        assigns(:comment).should eq(comment)
      end
